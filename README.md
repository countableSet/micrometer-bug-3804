...
When `javax.*` dependency isn't included in the project, the class `io.micrometer.core.instrument.binder.http.HttpRequestTags` does not compile when using `implementation("io.micrometer:micrometer-jetty11:$micrometerVersion")` version of TimeHandler.

## using `HttpJakartaServletRequestTagsProvider` in a lambda
...
/micrometer-bug/src/test/java/dev/example/test/TimedHandlerTest.java:55: error: cannot access HttpServletRequest
            HttpRequestTags.method(request),
                           ^
  class file for javax.servlet.http.HttpServletRequest not found
/micrometer-bug/src/test/java/dev/example/test/TimedHandlerTest.java:56: error: cannot access HttpServletResponse
            HttpRequestTags.status(response),
                           ^
  class file for javax.servlet.http.HttpServletResponse not found
/micrometer-bug/src/test/java/dev/example/test/TimedHandlerTest.java:57: error: cannot access HttpServletResponse
            HttpRequestTags.outcome(response)));
                           ^
  class file for javax.servlet.http.HttpServletResponse not found
3 errors
...
## using `HttpJakartaServletRequestTagsProvider` in a custom class
...
/micrometer-bug/src/main/java/dev/example/test/CustomHttpJakartaServletRequestTagsProvider.java:17: error: cannot access HttpServletRequest
        HttpRequestTags.method(request),
                       ^
  class file for javax.servlet.http.HttpServletRequest not found
/micrometer-bug/src/main/java/dev/example/test/CustomHttpJakartaServletRequestTagsProvider.java:18: error: cannot access HttpServletResponse
        HttpRequestTags.status(response),
                       ^
  class file for javax.servlet.http.HttpServletResponse not found
/micrometer-bug/src/main/java/dev/example/test/CustomHttpJakartaServletRequestTagsProvider.java:19: error: cannot access HttpServletResponse
        HttpRequestTags.outcome(response));
                       ^
  class file for javax.servlet.http.HttpServletResponse not found
3 errors
...
+--- io.micrometer:micrometer-jetty11:1.10.6
...
+--- jakarta.servlet:jakarta.servlet-api:5.0.0 (n)
+--- jakarta.ws.rs:jakarta.ws.rs-api:3.0.0 (n)
+--- io.micrometer:micrometer-jetty11:1.10.6 (n)
